<?php if( have_rows('content_panels','option') ): ?>

  <div id="footerPanels" class="row justify-content-center">
  
    <?php $layout_counts = array();

    while ( have_rows('content_panels','option') ) : the_row();
...
if( get_row_layout() == 'content_panel' ): 
  ...
  // Count the rows
  $totalrows = count( get_sub_field('content_box','option') ); ?>

  <div
    <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?>
    class="col-12 contentPanel<?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>"
    <?php if( get_sub_field('hide_date','option') ) { ?> data-hideDate="<?php the_sub_field('hide_date','option') ?>"
    <?php } if( get_sub_field('show_date','option') ) { ?> data-showDate="<?php the_sub_field('show_date','option') ?>" <?php } ?>
  >  
        ...
        <div class="contentContent row align-items-center justify-content-around">
          ...
          <?php if( have_rows('content_box','option') ): ?>
            ...
            <?php while( have_rows('content_box','option') ): the_row(); ?>
              ...
              <?php if( $totalrows == 1 ) { ?>
                <div class="col-12 innerBox align-self-<?php the_sub_field('vertical_alignment','option') ?>">
              <?php } elseif( $totalrows == 2 ) { ?>
                <div class="col-12 col-md-6 innerBox align-self-<?php the_sub_field('vertical_alignment','option') ?>">
              <?php } elseif( $totalrows == 3 ) { ?>
                <div class="col-12 col-lg-4 innerBox align-self-<?php the_sub_field('vertical_alignment','option') ?>">
              <?php } ?>
                <div class="content row justify-content-center">
                  <div class="col-12">
                    <?php the_sub_field('content','option') ?>

                    <?php if( have_rows('button','option') ): while( have_rows('button','option') ): the_row();
                      ...
                      <div class="btns <?php the_sub_field('alignment','option') ?>">
  ...
  >  
    <div class="row align-items-center justify-content-center">
      <div class="col-12 col-lg-11">
        ...
        <?php /* Tabs */ if( have_rows('content_box','option') ): $rownum = 1; ?>
          ...
          <?php /* Content */ if( have_rows('content_box','option') ): $rownum = 1; ?>
...
elseif( get_row_layout() == 'content_image_panel' ):
  ...
  // Get image
  $img_id = get_sub_field('image','option');
  $size = 'large';
  ...
  > 
    <div class="row justify-content-center">
      <?php if( get_sub_field('type','option') == 'normal' ) { ?>
      <div class="col-12 col-lg-11">
        <div class="contentImage row align-items-<?php the_sub_field('vertical_alignment','option') ?> justify-content-around">
          ...
          <div class="col-12 col-md-6 <?php the_sub_field('layout','option') ?> innerImg <?php the_sub_field('img_align','option') ?>">
            <img src="<?php echo $image[0]; ?>" />
          </div>

        </div>
      </div>
      <?php } elseif( get_sub_field('type','option') == 'full' ) { ?>
      ...
      <?php } elseif( get_sub_field('type','option') == 'small' ) { ?>
        <div class="col-12 col-lg-11 smallImg">
          <div class="contentImage row align-items-<?php the_sub_field('vertical_alignment','option') ?> justify-content-around">
            ...
            <div class="col-12 col-md-3 <?php the_sub_field('layout','option') ?> innerImg <?php the_sub_field('img_align','option') ?>">
              <img src="<?php echo $image[0]; ?>" />
            </div>
...
elseif( get_row_layout() == 'content_sidebar_panel' ): ?>
  ...
  <div 
    <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?>
    class="col-12 contentSidebar contentPanel<?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>"
    <?php if( get_sub_field('hide_date','option') ) { ?> data-hideDate="<?php the_sub_field('hide_date','option') ?>" 
    <?php } if( get_sub_field('show_date','option') ) { ?> data-showDate="<?php the_sub_field('show_date','option') ?>" <?php } ?>
  >
    <div class="row mainContent align-items-center justify-content-center">
      <div class="col-12 col-lg-11">
        <div class="row align-items-start justify-content-between">
          ...
          <?php if(get_sub_field('sidebar_location','option') == 'right') { ?>
          ...
          <?php } elseif(get_sub_field('sidebar_location','option') == 'left') { ?>
...
elseif( get_row_layout() == 'feature_boxes' ):
  ...
  $totalrows = count( get_sub_field('boxes','option') ); ?>

  <div 
    <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?>
    class="featureBoxes col-12 col-xl-11<?php if( get_sub_field('custom_class') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>"
    <?php if( get_sub_field('hide_date','option') ) { ?> data-hideDate="<?php the_sub_field('hide_date','option') ?>"
    <?php } if( get_sub_field('show_date','option') ) { ?> data-showDate="<?php the_sub_field('show_date','option') ?>" <?php } ?>
  >    
    <div class="row align-items-center justify-content-center">

    <?php if( have_rows('boxes','option') ): $rownum = 1; while ( have_rows('boxes','option') ) : the_row(); 
    ...
    $img_id = get_sub_field('bg_image','option');
    $size = 'large';
    $image = wp_get_attachment_image_src( $img_id, $size ); ?>

      <?php if( get_sub_field('bg_image','option') ) { ?>
        <?php if( $totalrows == 4 ) { ?>
        <div class="col-12 col-sm-6 col-xl featureBox row<?php echo $rownum; ?> total<?php echo $totalrows; ?>">
          <div class="row" 
            style="background-image: url('<?php echo $image[0]; ?>');
                    background-position: <?php the_sub_field('bg_horizontal_alignment','option') ?> <?php the_sub_field('bg_vertical_alignment','option') ?>;"
          >
        <?php } elseif( $totalrows == 3 ) { ?>
          <div class="col-12 col-md featureBox row<?php echo $rownum; ?> total<?php echo $totalrows; ?>">
            <div class="row" 
              style="background-image: url('<?php echo $image[0]; ?>');
                      background-position: <?php the_sub_field('bg_horizontal_alignment','option') ?> <?php the_sub_field('bg_vertical_alignment','option') ?>;"
            >
        <?php } else { ?>
          <div class="col-12 col-md featureBox row<?php echo $rownum; ?> total<?php echo $totalrows; ?>">
            ...
            >
        <?php } ?>
            <?php if(get_sub_field('content_alignment_vert','option') == 'align-items-start') { ?>
              <div class="overlay" style="background: linear-gradient(to bottom, rgba(<?php echo $feature_overlay_color ?>,<?php the_sub_field('overlay_opacity','option') ?>) 30% 20%, transparent 50%);"></div>
            <?php } elseif(get_sub_field('content_alignment_vert','option') == 'align-items-end') { ?>
              <div class="overlay" style="background: linear-gradient(to top, rgba(<?php echo $feature_overlay_color ?>,<?php the_sub_field('overlay_opacity','option') ?>) 30% 20%, transparent 50%);"></div>
            <?php } elseif(get_sub_field('content_alignment_vert','option') == 'align-items-center') { ?>
              <div class="overlay" style="background: rgba(<?php echo $feature_overlay_color ?>,<?php the_sub_field('overlay_opacity','option') ?>);"></div>
            <?php } ?>
            <div class="col-12 content">
              <div class="row <?php the_sub_field('content_alignment_vert','option') ?> <?php the_sub_field('content_alignment','option') ?>" style="height: 100%;">
                <div class="col-12<?php if( $totalrows == 1 || $totalrows == 2 ) { ?> col-lg-8 col-xl-7<?php } ?>" style="color:<?php the_sub_field('text_color','option') ?> !important;">
                  <?php the_sub_field('content','option') ?>
                
                  <div class="button col-12 align-self-end <?php the_sub_field('button_alignment','option') ?>">
...
elseif( get_row_layout() == 'feature_slider' ): ?>
  ...
  <div 
    <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?>
    class="featureSlide col-12 p-0<?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>"
    <?php if( get_sub_field('hide_date','option') ) { ?> data-hideDate="<?php the_sub_field('hide_date','option') ?>" 
    <?php } if( get_sub_field('show_date','option') ) { ?> data-showDate="<?php the_sub_field('show_date','option') ?>" <?php } ?>
  >
    <div class="row align-items-center justify-content-center">
      ...
      <?php while( have_rows('slides','option') ) : the_row();
        ...
        if( have_rows('boxes','option') ): $rownum = 1; ?>
...
elseif( get_row_layout() == 'small_blocks' ): ?>
  ...
  <div 
    <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?>
    class="col-12 blocksWrap contentPanel<?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>"
  >
    <div class="row align-items-center justify-content-center">
      <div class="col-12 col-lg-11">

        <div class="smallBlocks row align-items-start <?php the_sub_field('alignment','option') ?>">
...
elseif( get_row_layout() == 'flip_blocks' ): ?>
  ...
  <div 
    <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?>
    class="col-12 flipWrap contentPanel<?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>"
  >
    <div class="row align-items-center justify-content-center">
      <div class="col-12 col-lg-11">
        <div class="flipBlocks row card-row <?php the_sub_field('alignment','option') ?>">

          <?php if( have_rows('flip_blocks','option') ): ?>

            <?php while( have_rows('flip_blocks','option') ): the_row(); 
              ...
              $icon_img_id = get_sub_field('icon','option');
              $icon_size = 'thumbnail';
              $icon_image = wp_get_attachment_image_src( $icon_img_id, $icon_size ); 
              
              $hover_img_id = get_sub_field('hover_bg_image','option');
              $hover_size = 'medium';
                  ...
                  <div class="col-12 card text-center">
                    <div class="row align-items-center card-hover text-center" 
                      style="background-image:<?php echo $hover_image[0]; ?>;
                              background-color:<?php the_sub_field('hover_bg_color','option') ?>;
                              color:<?php the_sub_field('hover_text_color','option') ?>;"
                    >
                      <div class="col-12 card-hover-content">
                        <div class="body">
                          <h5><?php the_sub_field('title','option') ?></h5>
                          <?php the_sub_field('hover_content','option') ?>
                          <?php $link = get_sub_field('btn_link','option');
                                if( $link ) {
                                  $link_url = $link['url'];
                                  $link_target = $link['target'] ? $link['target'] : '_self';
                                } ?>

                                <?php if( get_sub_field('btn_text','option') && get_sub_field('btn_link','option') ) { ?>
                                  <a href="<?php echo esc_url($link_url); ?>" target="<?php echo esc_attr($link_target); ?>" class="btn btn-<?php the_sub_field('btn_type','option') ?>">
                                    <?php the_sub_field('btn_text','option') ?>
                                  </a>
                                <?php } ?>
                        </div>
                      </div>
                    ...
                    <div class="row align-items-center card-not-hover text-center" 
                      style="background-image:<?php echo $image[0]; ?>;
                              background-color:<?php the_sub_field('bg_color','option') ?>;
                              color:<?php the_sub_field('text_color','option') ?>;"
                    > 
                      <div class="col-12 card-not-hover-content">  
                        <div class="body">
                          <img class="icon" src="<?php echo $icon_image[0]; ?>" />
                          <h5 class="title"><?php the_sub_field('title','option') ?></h5>
                        </div>
                      </div>
                    </div>
                  </div>
...
elseif( get_row_layout() == 'feature_panel' ):
  ...
  if( get_sub_field('bg_type','option') == 'image' ) {
    ...
    if( get_sub_field('bg_mobile','option') ) {
      ...
      <div 
        <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?>
        class="col-12 featurePanel contentPanel <?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>" 
        style="background-image: url('<?php echo $imageMobile[0]; ?>'); 
                ...
                background-size: <?php the_sub_field('mobile_size','option') ?>; 
                <?php if(get_sub_field('panel_type','option') == 'fixed') { ?>min-height:<?php the_sub_field('panel_height','option') ?>px;<?php } ?>" 
        data-showDate="<?php the_sub_field('show_date','option') ?>" data-hideDate="<?php the_sub_field('hide_date','option') ?>"
      >
      ...
      <div 
        ...
        style="background-image: url('<?php echo $imageDesk[0]; ?>'); 
                background-position: <?php the_sub_field('horz_align_desk','option') ?> <?php the_sub_field('vert_align_desk','option') ?>; 
                background-size: <?php the_sub_field('desk_size','option') ?>; 
                <?php if(get_sub_field('panel_type','option') == 'fixed') { ?>min-height:<?php the_sub_field('panel_height','option') ?>px;<?php } ?>" 
                data-showDate="<?php the_sub_field('show_date','option') ?>" data-hideDate="<?php the_sub_field('hide_date','option') ?>"
      >
    ...
    <div 
      <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?> 
      class="col-12 featurePanel contentPanel <?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>"
      <?php if(get_sub_field('panel_type','option') == 'fixed') { ?>style="min-height:<?php the_sub_field('panel_height','option') ?>px;"<?php } ?> 
      data-showDate="<?php the_sub_field('show_date','option') ?>" data-hideDate="<?php the_sub_field('hide_date','option') ?>"
    >
  ...
  <?php } ?>
    ...
    <?php if( wp_is_mobile() ) { ?>
      <div class="overlay" style="background: rgba(<?php echo $featPanel_overlay_color ?>,<?php the_sub_field('overlay_opacity_mob','option') ?>);"></div>
    <?php } else { ?>
      <div class="overlay" style="background: rgba(<?php echo $featPanel_overlay_color ?>,<?php the_sub_field('overlay_opacity_desk','option') ?>);"></div>
    <?php } ?>

    <div class="row <?php the_sub_field('alignment','option') ?> <?php the_sub_field('panel_type','option') ?>">
      <div class="col-12 col-xl-11">
        <div class="row <?php the_sub_field('alignment_vert','option') ?>" style="height:100%; color:<?php the_sub_field('text_color','option') ?>;">
...
elseif( get_row_layout() == 'gallery' ):
  ...
  <div 
    <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?> 
    class="col-12 galleryWrap contentPanel<?php if( get_sub_field('custom_class') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>"
  >
      <div class="row align-items-center justify-content-center">
        
        <div class="col-12">
          <?php if( get_sub_field('intro','option') ) { ?>
            <div class="row">
              <div class="col-12 galleryContent">
                <?php the_sub_field('intro','option') ?>
              </div>
            </div>
          <?php } ?>
...
elseif( get_row_layout() == 'testimonial_slider' ):
  ...
  if( $the_query->have_posts() ): ?>
    ...
    <div 
      <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?> 
      class="col-12 testSliderWrap contentPanel<?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>" 
    >
      <div class="row align-items-center justify-content-center">
        <div class="col-12">
          <?php if( get_sub_field('intro','option') ) { ?>
...
elseif( get_row_layout() == 'faq_panel' ):
  ...
  <div 
    <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?> 
    class="col-12 faqPanel contentPanel<?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>" 
  >
    <div class="row align-items-center justify-content-center">
      <div class="col-12 col-lg-11">
        <?php if( get_sub_field('intro','option') ) { ?>
        ...
        <div id="accordion<?php if( get_sub_field('custom_id','option') ) {?>-<?php the_sub_field('custom_id','option') ?><?php } ?>">
...
elseif( get_row_layout() == 'location' ): ?>
  ...
  <div 
    <?php if( get_sub_field('custom_id','option') ) {?>id="<?php the_sub_field('custom_id','option') ?>"<?php } ?> 
    class="col-12 locationPanel<?php if( get_sub_field('custom_class','option') ) { ?> <?php the_sub_field('custom_class','option') ?><?php } ?>"
  >
    <div class="row justify-content-center">
